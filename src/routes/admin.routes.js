...
router.post("/property/add", auth, upload.array("images", 10), propertyController.addproperty)
router.put("/property/update", auth, upload.array("images", 10), propertyController.editproperty)
